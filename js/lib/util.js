...
Explo.prototype.$constructor = function(canvas, img, opt){
	this.ec = [];
	this.pos = { x : 0, y : 0 };
...
Explo.prototype._mdown = function(e, elm){
	...
	this.pos = coords;
	var bPos = JAK.DOM.getBoxPosition(this.domCanvas);
	this.pOpt.posX = this.pos.x - bPos.left;
